...
function createGeometry(){
    ...
    let boxmaterial=new THREE.MeshPhysicalMaterial({color:"#FCD440"});
    let box = new THREE.Mesh(Sphere,boxmaterial);
    boxmaterial.emissiveIntensity=5;
    box.position.y=4.8;
    box.position.x=0;

    let mecury=new THREE.SphereGeometry(2,14,14);
    let mecmaterial = new THREE.MeshPhysicalMaterial({color:"#3CB371"});
    let mec=new THREE.Mesh(mecury,mecmaterial);
    mec.position.y=4;
    mec.position.x=25;

    let venus=new THREE.SphereGeometry(3.5,14,14);
    let venmaterial = new THREE.MeshPhysicalMaterial({color:"#DBCECA"});
    ...
    let earmaterial = new THREE.MeshPhysicalMaterial({color:"#1E90FF"});
    ear=new THREE.Mesh(earth,earmaterial);
    ear.position.y=5;
    ear.position.x=50;

    let earthMoon=new THREE.SphereGeometry(1.6,14,14);
    let earmoonmaterial = new THREE.MeshPhysicalMaterial({color:"#808080"});
    ...
    let jupmaterial3 = new THREE.MeshPhysicalMaterial({color:"#808080"});
    ...
    let jupmaterial4 = new THREE.MeshPhysicalMaterial({color:"#808080"});
    ...
    let jupmaterial5 = new THREE.MeshPhysicalMaterial({color:"#808080"});
    ...
    let satmaterial = new THREE.MeshPhysicalMaterial({color:"#F0E68C"});
    sat=new THREE.Mesh(saturn,satmaterial);
    sat.position.y=8.9;
    sat.position.x=110;

    let satMoon=new THREE.SphereGeometry(1.6,14,14);
    let satmoonmaterial = new THREE.MeshPhysicalMaterial({color:"#808080"});
    ...
    let satmoonmaterial2 = new THREE.MeshPhysicalMaterial({color:"#808080"});
    ...
    let satmoonmaterial3 = new THREE.MeshPhysicalMaterial({color:"#808080"});
    ...
    let uramaterial = new THREE.MeshPhysicalMaterial({color:"#00BFFF"});
    let ura=new THREE.Mesh(uranus,uramaterial);
    ura.position.y=8.9;
    ura.position.x=130;

    let Neptune=new THREE.SphereGeometry(4.5,14,14);
    let Nepmaterial = new THREE.MeshPhysicalMaterial({color:"#0000FF"});
    let Nep=new THREE.Mesh(Neptune,Nepmaterial);
    Nep.position.y=8.9;
    Nep.position.x=150;

    let pluto=new THREE.SphereGeometry(1.4,14,14);
    let plumaterial = new THREE.MeshPhysicalMaterial({color:"#8B4513"});
...
function SetupLights(){
    ...
    light2.color=new THREE.Color({color:"#0000FF"});
    scene.add(light2);
...
function render(){
   ...
   // individual container foreach planent;
